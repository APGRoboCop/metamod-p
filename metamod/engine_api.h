...
typedef void (*FN_DELTASETFIELD) (delta_s* pFields, const char* fieldname);
typedef void (*FN_DELTAUNSETFIELD) (delta_s* pFields, const char* fieldname);
typedef void (*FN_DELTAADDENCODER) (char* name, void (*conditionalencode)(delta_s* pFields, const unsigned char* from, const unsigned char* to));
typedef int (*FN_GETCURRENTPLAYER) ();
typedef int (*FN_CANSKIPPLAYER) (const edict_t* player);
typedef int (*FN_DELTAFINDFIELD) (delta_s* pFields, const char* fieldname);
typedef void (*FN_DELTASETFIELDBYINDEX) (delta_s* pFields, int fieldNumber);
typedef void (*FN_DELTAUNSETFIELDBYINDEX) (delta_s* pFields, int fieldNumber);
