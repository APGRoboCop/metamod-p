...
#include "vdate.h"
 ...
 // Use const pointer to const data - prevents reassignment
const char* const COMPILE_TIME = __DATE__ ", " __TIME__;

#ifndef COMPILE_TZ
#define COMPILE_TZ "GMT"
#endif

const char* const COMPILE_TZONE = COMPILE_TZ;

// Include a string for /usr/bin/ident.
const char* const vstring = "\n$Pg: " VNAME " -- " VVERSION " | " __DATE__ " - " __TIME__ " $\n";